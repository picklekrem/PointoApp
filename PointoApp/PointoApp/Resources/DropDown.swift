...
class DropDown : UITextField{
    ...
    @IBInspectable public var arrowSize: CGFloat = 21 {
        didSet{
    ...
    fileprivate var listVisibleCompletion: (Bool) -> () = { visible in }
    ...
    func setupUI () {
        ...
        arrow = UIImageView(frame: CGRect(x: center.x - arrowSize/2, y: center.y - arrowSize/2, width: arrowSize, height: arrowSize))
        ...
        if isSearchEnable && handleKeyboard{
            showKeyboard { (keyboardRectangle) in
                self.keyboardHeight = keyboardRectangle.height
                    if !self.isSelected{
                        self.showList()
                    }
                }
            hideKeyboard { (hide) in
    ...
    public func showList() {
        ...
        UIView.animate(withDuration: 0.9,
                       ...
                       animations: { () -> Void in
                        ...
                        self.listVisibleCompletion(true)
    ...
    public func hideList() {
        ...
        UIView.animate(withDuration: 1.0,
                       ...
                       animations: { () -> Void in
                        ...
                        self.listVisibleCompletion(false)
        },
    ...
    public func changeVisibleList(completion: @escaping (_ visible:Bool) -> ()) {
        listVisibleCompletion = completion
    }
